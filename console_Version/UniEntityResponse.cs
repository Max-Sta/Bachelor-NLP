...
{
    public class UniEntityResponse
    {
        ...
        public class entity
        {
            ...
            public sentim sentiment { get; set; } // unused
        ...
        //über- beschreibt den + Operator für diese Klasse sodass einfach UniEntitites kombiniert werden können.
        public static UniEntityResponse operator +(UniEntityResponse combineEnt, UniEntityResponse combineIty)
        {
            //usage
